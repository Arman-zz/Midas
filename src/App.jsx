...
const translations = {
  ...
  'MIDAS connects you with verified partner jewelry shops nearby for direct or installment purchases. We track every agreement, payment record, and delivery, but your money always moves directly between you and the shop.': 'MIDAS আপনাকে নিকটস্থ যাচাইকৃত অংশীদার জুয়েলারি দোকানের সঙ্গে সরাসরি বা কিস্তিতে কেনাকাটার জন্য যুক্ত করে। আমরা প্রতিটি চুক্তি, পেমেন্ট রেকর্ড ও ডেলিভারি অনুসরণ করি, তবে আপনার অর্থ সবসময় সরাসরি আপনার ও দোকানের মধ্যে লেনদেন হয়।',
  ...
  'Find approved shops near you, compare products and installment terms, and track every payment record and delivery milestone in one place.': 'নিকটস্থ অনুমোদিত দোকান খুঁজুন, পণ্য ও কিস্তির শর্ত তুলনা করুন এবং সব পেমেন্ট রেকর্ড ও ডেলিভারির অগ্রগতি এক জায়গায় দেখুন।',
  'For Shop Owners': 'দোকান মালিকদের জন্য',
  'Confirm, fulfil, earn': 'নিশ্চিত করুন, সরবরাহ করুন, আয় করুন',
  ...
  'List eligible gold for sale, or browse listings from other members. MIDAS provides discovery, messaging, and a transaction record. Inspection, payment, and handover stay between buyer and seller.': 'যোগ্য স্বর্ণ বিক্রির জন্য তালিকাভুক্ত করুন অথবা অন্য সদস্যদের তালিকা দেখুন। MIDAS খোঁজ, যোগাযোগ ও লেনদেনের রেকর্ড দেয়। পরিদর্শন, পেমেন্ট ও হস্তান্তর ক্রেতা ও বিক্রেতার মধ্যেই থাকে।',
